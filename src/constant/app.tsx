...
export const recommendationsGroups = [
  ...
  [
    { image: '/testimonial/img-3.png', name: 'Myro Mera', position: 'Junior Programmer at TemaroTech', text: 'He is not only a brilliant programmer but also a dependable teammate. In every competition, he brings sharp logic, calm focus, and a positive attitude that lifts the whole team. Working with him has been both inspiring and fun.”' },
  ...
  [
    ...
    { image: '/testimonial/img-6.png', name: 'Andrew Robin', position: 'Computer Programmer at LGU SJDM Bulacan', text: 'He is an excellent full stack developer combines strong foundational skills with a growth mindset, quickly adapting to new technologies, writing clean and efficient code, and actively contributing to team success through collaboration and continuous learning.”' },
  ],
